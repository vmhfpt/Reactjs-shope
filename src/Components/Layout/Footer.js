...
function Footer() {
  ...
  const [historySearch, setHistory] = useState([]);
  const handleSeacher = (value) => {
    setHistory([...historySearch, value]);
  };
    ...
    <div style={{ height: "400px" }} class="app">
      <header class="header">
        <div class="grid wide">
          <nav class="header__navbar hide-on-mobile-tablet">
            <ul class="header__navbar--list">
              ...
              <li class="header__navbar--item">
                ...
                <a
                  href="https://www.facebook.com/contact.hongduc/"
            ...
            <ul class="header__navbar--list">
                  ...
                  <ul class="header__notify--list">
                    <li class="header__notify--item">
                      <a href="" class="header__notify--link">
                        <img
                          src="./assets/img/img-produce.jpg"
              ...
              <li class="header__navbar--item header__navbar--item--bold header__navbar--item--separate">
                <Link to="/user/resign"> Đăng kí</Link>
              </li>
              ...
              <li class="header__navbar--item header__navbar-user">
                <img
                  src="https://avatar-redirect.appspot.com/google/106476986122004287732?size=400"
                  alt=""
                  class="header__navbar-user-img"
                />
                <span class="header__navbar-user-name">Nguyễn Hồng Đức</span>
          ...
          <div class="header-with-search">
            ...
            <div class="header__search">
              <div class="header__search-input-wrap">
                ...
                <div class="header__search-history">
                  ...
                  <ul class="header__search-history-list">
                    ...
                    {historySearch.map((index, value) => (
                        
                      <li key={value} class="header__search-history-item">
                        <a href="">{index}
              ...
              <Link
                onClick={() => handleSeacher(search)}
                to={`/dtdd/search/${search}`}
              >
                {" "}
            ...
            >
              <div class="header__cart-wrap">
                <div onClick={() => dispatch(actions.showCart(state.showCard))}>
                  <i class="header__cart-icon fas fa-shopping-cart"></i>
                  <span class="header__cart-notice">{sumQuantityArray}</span>
                </div>
        ...
        <ul class="header__sort-bar">
          ...
          <li class="header__sort-item">
            <a href="" class="header__sort-link">
              Giá <i class="header__sort-icon fas fa-arrows-alt-v"></i>
            </a>
          </li>
        </ul>
      </header>
